...
type BlindedBlobSidecar struct {
	...
	ProposerIndex   github_com_OffchainLabs_prysm_v7_consensus_types_primitives.ValidatorIndex `protobuf:"varint,5,opt,name=proposer_index,json=proposerIndex,proto3" json:"proposer_index,omitempty" cast-type:"github.com/OffchainLabs/prysm/v7/consensus-types/primitives.ValidatorIndex"`
...
var file_proto_prysm_v1alpha1_blobs_proto_goTypes = []any{
