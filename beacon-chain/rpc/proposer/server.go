// Package proposer implements block proposal logic extracted from the v1alpha1 validator service.
package proposer
...
// Server defines the proposer server for block production and proposal.
type Server struct {
	Ctx                              context.Context
