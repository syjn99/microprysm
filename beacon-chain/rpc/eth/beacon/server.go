...
// BlockProposer defines the interface for proposing signed beacon blocks.
type BlockProposer interface {
	ProposeBeaconBlock(ctx context.Context, req *eth.GenericSignedBeaconBlock) (*eth.ProposeResponse, error)
}
